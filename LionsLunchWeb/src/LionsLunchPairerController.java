...
public class LionsLunchPairerController {
    public static void main(String [] args){
        ...
        //LLDBController.deleteMember("tst3");
        ...
        LionsLunchMemberModel ob = new LionsLunchMemberModel("oddbreaker", "testloldamnit", "0000000000", "testing1@gmail.com", "Junior", false, "Business", "full access", false, "introverted", "none", null);
    ...
    public static ArrayList<LionsLunchMemberModel> pairLionsIE(ArrayList<LionsLunchMemberModel> buddies, LionsLunchMemberModel oddBreaker){
        ...
        if (remaining.size() % 2 != 0){
            ...
            LionsLunchMemberModel bm = new LionsLunchMemberModel("Board Member", "bm0000", "0000000000", "justin.kang@utexas.edu", "Senior", false, "Business", "full access", false, "introverted", "none", null);
