 ...
 */
public class LionsLunchMemberModel implements java.io.Serializable{
    ...
    private String weeklyPair = null;
    private String personality = null;
    private String additionalInfo = null;
    private String pastPairs = "";
    private ArrayList<LionsLunchMemberModel> potentialPairs = null;

    public LionsLunchMemberModel(String initEID, String initName, String initPhoneNumber, String initEmailAddress, String initYearClassification,
                                 Boolean initPairMajor, String initMajor, Boolean initPermissions, String initWeeklyPair, String initPersonality, String initAdditionalInfo, String initPastPairs){
        this.name = initName;
        this.eid = initEID;
        ...
        this.potentialPairs = new ArrayList<LionsLunchMemberModel>();
    }
    ...
    public void setPermissions(Boolean sSetPermissions){this.permissions = sSetPermissions;}

    public Boolean getPermissions(){return this.permissions;}

    public void setWeeklyPair(String sWeeklyPair){this.weeklyPair = sWeeklyPair;}

    public String getWeeklyPair(){return this.weeklyPair;}
    ...
    public void addPotentialPair(LionsLunchMemberModel toAdd){this.potentialPairs.add(toAdd);}

    public ArrayList<LionsLunchMemberModel> getPotentialPairs(){return this.potentialPairs;}

    public void clearPotentialPairs(){this.potentialPairs = new ArrayList<LionsLunchMemberModel>();}

    public void setPotentialPairs(ArrayList<LionsLunchMemberModel> sPotentialPairs){this.potentialPairs = sPotentialPairs;}
