 ...
 */
public class ListCreatorController {
    public static void makeListFile(ArrayList<LionsLunchMemberModel> list) throws FileNotFoundException, UnsupportedEncodingException {
