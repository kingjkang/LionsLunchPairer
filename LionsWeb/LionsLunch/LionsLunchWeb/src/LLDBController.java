...
//        String url = "jdbc:mysql://localhost/lionsLunch";
        String url = "jdbc:mysql://localhost:3306/lionsLunch";
//        String user = "root";
        String user = "lunchAdmin";
    ...
    public static void addMember(String initEID, String initName, String initPhoneNumber, String initEmailAddress, String initYearClassification,
                                 Boolean initPairMajor, String initMajor, Boolean initPermissions, String initWeeklyPair, String initPersonality, String initAdditionalInfo){
        ...
        try {
            ...
            preparedStmt.setBoolean(8, initPermissions);
            preparedStmt.setString(9, initWeeklyPair);
    ...
    public static void updatePastPairs(LionsLunchMemberModel updatingMember){
    ...
    public static ArrayList<LionsLunchMemberModel> getMemberInfo(){
        ArrayList<LionsLunchMemberModel> memz = new ArrayList<LionsLunchMemberModel>();
        try {
            ...
            while (rs.next()){
                ...
                Boolean permission = rs.getBoolean("member_permission");
                String weeklyPair = rs.getString("member_weekly_pair");
                ...
                addMem = new LionsLunchMemberModel(eid, name, phone, email, year, pairMajor, major, permission, weeklyPair, personality, addInfo, pastPairs);
                memz.add(addMem);
            }
    ...
    public static void getFromDB(){
        ...
        try {
            ...
            Logger lgr = Logger.getLogger(LLDBController.class.getName());
